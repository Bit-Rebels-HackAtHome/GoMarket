<template>
  <q-page class="q-pa-md column justify-start flex-center">
    ...
    <q-list class="q-mt-md" bordered separator v-if="supermercati.length">
      <q-item v-for="(supermercato,ind) in supermercati" :key="ind+0.1" clickable v-ripple>
...
export default {
  ...
  methods: {
    onSubmit: function(event) {
      this.$axios
        .get(
          `http://localhost:8080/maps/api/place/textsearch/json?query=supermercati+${this.citta}&key=AIzaSyCOzGEFceRf-uFXs8kLWIzQB9wTXCPxbMQ`
        )
        .then(response => {
    ...
    mostraRisultati(response) {
      console.log("entrato");
      var results = response.data.results.length ? response.data.results : [
  {
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAm40kR0fLzfkn98acQXg8iJz9tegob-TjqkvwweFuNkeSjRSGvnJ_ZXFP4LO7rS-RQqyu8ftYE6dnuRsEwyhb28-FLG56MfViAAp6bSK0CtHlYpH_sg1MTkAasHfGrXbFEhD3c5lUxtNoDrfjaFmmJp6EGhQsBz-TQErl9HUOLU6gGGcJxjxRtQ",
        "width": 1600
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAZ7kJJ5j3WaHTJKS--NEIL3eHAli7s2p_o2Vu9RZQ4E5HofLwsR3-FRUMhcKkMbBnLy2yOk1lW5krmcCB7WIvGODcrlnB1YyIbkmBSi7sO4KnG2ENrgnv0ks5pBfpcW0rEhDs-WeI-N5DNo8byzzcI0YZGhR-wEu0zGuuDmvPwhgjwkwd8b8sxA",
        "width": 3120
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAgCjbiOsteM6Xk0Ypjdkn5VJYyMqzQkBLXEjhPwUhZgy2FrnK99ChgwwJee3TqWgpU9RhEeG30RqarbAEccHXYB6g9De-CO6ZWJvbux0zT8hy-0K63pqSlWfRl7yxzEegEhBIo_0dggnavPA6vvviqUZyGhRIZ0WcksVieENngZRXeqNLB0_gZw",
        "width": 1080
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRZAAAAe8ZZzT8Z6ypfqDlkQt8CgmtDBhaUYs1zGdgTy-HLcIX9zC3CwsqREbQPqN7-zXgxG8cczOX3FuZIjHsA-PSexE6VzdpLSbhC3Wk2EXLtJcRXYr3UDAG9iiyr0cpsWGL-EhBvB_7nJLoemRA1bHITow12GhRshCq-pKcnnTmMQVvB-_5WGVWsow",
        "width": 1080
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAs7BeKqK9t_gj1K1qVZ1pZgGJNx-l4LIejXYZ4I7MXmLtapanPT-we9k0NCIZNAGM1lqMwdpoF2V19FWzVXXcnXV8EKguYoBrm3nwv91jYXI69lhe9Tbhs-R3TJSqDADjEhBnvZ7DVRABBu7Z54JSUKTQGhRa9tbWAzF91b69gxUvqAoizGp8Zg",
        "width": 2448
      }
    ],
  ...
  {
    "formatted_address": "Piazza Argentina Ang, Via Antonio Stradivari, 20124 Milano MI, Italia",
    "geometry": {
      "location": {
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAARt_mosQU7bsDPUPr_Tm9QuAF0lvpue5RRbg6jLlGheLOcl2e4anf-Fc1gMWH0WxZjy50QB7oi6KHHpzQDKaz3H-SbOSPy_7pXesrEjs5KTw4jciWEyzQpbDDMUqkhX_YEhDq9ZFiAocYU5O7bI0WPKy9GhSPDmaIyuVwj5izNbiZJ0afEABHTw",
        "width": 3264
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAozmiosc05OvS85BMdzuLqVz-HdasYKt9UZO-PRjBGwhvCXkV-Rey2ytyJpuaq_BarhkDdbLmkukvKLZy9SMdIVmiC61AUA4ui4P2lTUiXaEgp5t4p9tmxu70iVGQ_EGXEhB44NOE-ZVgLEATcIrrPd3cGhTJqrkmTAT-M58S99qK9Rsxkoivdw",
        "width": 5312
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAACWJBKxwNY6EAt3Qi2cq9WAdCZJNtD2AMC1baAREHpS1lVf4aAHHoinhxR8AQSwUgALqs8GdXi_7oaJiAO_dTktrs4uwl4vYeerA-S44Wox8i7mG60MZqHT7n6JzR3HpEEhAKqAQD0P2xUZEH0Z1Y0EgxGhQIUApMoxrDdWRnhEnCZHqpHyI_vA",
        "width": 2048
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAxO5pEyC3MoHb7evHdXPto4V-GPimXQDNm1S3faY0Oo4w-QfG78ysdLmbvxaplW59NbwKdapjMgQ6zr-Gr0LtTK4gahNl-CnMRMUCw2ZkHb7sALbZ71mN7NxIhZ8xquHQEhDLZtF3H4w7E7cE0nmWEbvuGhRR82eVzlT0fhcxSgVUStnHlIxsVg",
        "width": 4032
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAZGE6bPiep4aexceUF0EAt6jnjvR3Y3h0bgfMTdioO5rD-HonplmdEPgYqg2uKx3IBNcb4ckIYgwiMf6vKEtOFLCRK5Vn6Z_Iq_-qs3ZQohOu8xw_fiUz_PJPNffstzF6EhBEliJ1q49baDPXTja5AKRAGhRoendUK5GqADkaZAvbd2ZsSpodlg",
        "width": 3968
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAARMiHSkT9qxWyIEviNGVl_CXsNKnnTs-XxZKp_3UzT5Q5D8XBNu5SCCs18ay3g4dHqd_cQXO4563EsoER_-Ni25bIoNqSZqk2485KXS3vDiK_uu5LbI9WUXmC2bOG29W7EhBOmjj2jDJmLrJdKZYs70RjGhQs3GLz2X1vGKS9_RQWXoLUh-qQNw",
        "width": 4032
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAbglmk3Ma15omy9D4g_cSuq7sxfK9mSd1x6lXnCG2HmdH7IvTjrbPsJIK8zHZHTQPi8A0JriSHHqaRtvfPbibkDdTP1dfXdraTWyp4wSDOT-qBtagRwpPe4ZAUqPRrUC4EhAMlFUyzSEiPDqG0Se5Z421GhRN16NidHPw0yEjnfOw13DCN8PzSA",
        "width": 1960
      }
    ],
  ...
  {
    "formatted_address": "Via Pier Alessandro Paravia, 77, 20148 Milano MI, Italia",
    "geometry": {
      "location": {
        "lat": 45.4737941,
        "lng": 9.1344604
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAbtTDV6Km2Vv_ASygJ-EvZyDQ06Z8WevwFI8AG0-OzCtme82Nm8f4BTE5ZwoU0H3tpqsKRenk838pbz0SI-v7YWeRWkDK8XQr7scs_XRVWXf5olyAg2fwiM0knDFRZOfCEhA6AjUKs32HfTIEaA-Kn4PlGhS6ign2_FB9oBhXsamMgPMk6WBRjQ",
        "width": 5312
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAFRC-LUO3kc6hch0U_C4WfCxnnarY1ZnBGZC73K6838pg8x2zTrKXg5VvJ6zv8bt14XjDHVI6OXddnyRXcslqSlY1nQz_8q09gYcocLFdBYA_iAW6YIJNvohA9PAivfhLEhDn0qqMqM4AWk6_7_r4doJ5GhSqheOOUJ_o_2PUrJmcnjZOSr9Hew",
        "width": 2736
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAWeC3lFGsTLh5Y9t1x-reJqCcn2-lDMkdzQLlE2kFq-Soyo0GMirazHhOnBLK73oFKQnoCGZSviMYEBZegs8l05CDEMpQNr9b22HyrzG2gBT8PHvMJFyOXrndGO3OrHKiEhAbmB5h8gKwob6_OGb80zd3GhSQQd4djqxyu4maMnxXYSQO_fZSxw",
        "width": 3024
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAxAxfmxEPVvxK-yLOoXOYVHTjU687cOBlyI_cJppSR22ApDMD921BOcaKlYl0FuupPf27fnsutsNoci9RUpLsPqxWbGtlBULA4iAc7usQWhMXqtadilcdM0RzOgkaB9Z4EhAWbUaCe60YNs9ebOSjFLNtGhTCV593MhVL65GAdwFT1hIXJM9eNg",
        "width": 5312
      }
    ],
  ...
  {
    "formatted_address": "Via Soderini, Viale S. Gimignano, 48, 20153 Milano MI, Italia",
    "geometry": {
      "location": {
        "lat": 45.4548293,
        "lng": 9.1356858
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAABBooMPsiBY-LLcBs9D_JJMWETwtu3ZRnbQj-CcU1rhZIn8880V2uHO0WjEtD7w_727TnCOWnRuzF8MLqYPB7i7jcyVDmY8zDmPVH-wwFl1-nJH3zqp4aMKI88aHVql3wEhBwGIhtRYX2vp9G7AKtbJHvGhT1XokMMlIHejqMHsVmgm4_vzDspw",
        "width": 2340
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAxkBcJDa-1bb6W1HOfVQGPyZ-z3cMPP30BchEhM2VtnaQvVKGk1QpWzzSx0Zz0XWdPmTiwltd_57PLWhAx1p5GZHydQtdyaiozCz0sV5WtEQbXv7D-PSU9EUMJNMKaQWlEhCFEZKJyz3iT2ptXBAqtcw5GhQFn4CfocGslotczAx03PubRPFxyw",
        "width": 1080
      }
    ],
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAbHm4o_iOPn_HWE-xjZWas5fllJOJ_OeQoZ45Stjonr1iuPenqziIG4PfJDwhEnmd6C9fmuobPOlceenQU4NvRDqiQacpx7t71XKPjZNGw8g9XTPzeUAvD1fIi-7lkHaZEhCoeYe2ArWUzf1uJZ7oyL13GhR_RlbeW-QknFLMmYsnaa3iuzIxgA",
        "width": 3264
      }
    ],
  ...
  {
    "formatted_address": "Largo Giovanni Battista Scalabrini, 1, 20146 Milano MI, Italia",
    "geometry": {
      "location": {
        "lat": 45.4505714,
        "lng": 9.1410459
    ...
    "photos": [
      {
        ...
        "photo_reference": "CmRaAAAAVW8VY1ZNbxkTZn9OlTTYhlLbmhcGGMDzaCExNEegHNBPFz1XTp1AIs2-KnMRhE5zyZJebMwOj8obBl-kYJ7X9V8PhhjAq4HHeCuA2CwQ_5MRP0KOZ_1CStTMw01lk7qoEhAl6BXf95X94rSDQbP8po_JGhTJGr64YjYarUPfOGinqfsIGpg2kA",
        "width": 3456
      }
    ],
